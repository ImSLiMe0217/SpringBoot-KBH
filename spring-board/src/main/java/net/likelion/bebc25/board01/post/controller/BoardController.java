...
public class BoardController {
    ...
    public BoardController() {
        this.fakePosts = new ArrayList<PostDto>();
        ...
        for (PostDto post : posts) {
            result += """
                            <tr>
                              <td>%d</td>
                              <td>
                                <a href="/01/board/detail.html?id=%s">%s</a>
                              </td>
                              <td>%s</td>
                              <td>%s</td>
                              <td>
                    ...
                    """.formatted(post.getId(), post.getId(), post.getTitle(), post.getAuthor(), post.getCreatedAt());
        }
    ...
    public String getDetail(@RequestParam("id") int id) {
        PostDto samplePost = getPosts().get(id - 1);
        ...
        result += """
                ...
                """.formatted(samplePost.getId(), samplePost.getTitle(), samplePost.getAuthor(), samplePost.getCreatedAt(), samplePost.getContent());

        result += """
                    <div>
                      <a href="/01/board/edit.html" class="btn">수정하기</a>
    ...
    public String writePost(@RequestParam("title") String title,
        ...
        return "redirect:list.html";    // list.html을 재요청
    }
